...
const I18N = {
  en: {
    ...
    'toast.roomExpired': 'Room not found or has expired.',
    'toast.serverFull': 'All servers are currently full. Please try again in a few minutes or join an existing public room.',
  ...
  he: {
    ...
    'lobby.minPlayers': 'צריך לפחות 3 שחקנים כדי להתחיל.',
    ...
    'toast.roomExpired': 'החדר לא נמצא או שפג תוקפו.',
    'toast.serverFull': 'כל השרתים מלאים כרגע. נסה שוב בעוד כמה דקות או הצטרף לחדר ציבורי קיים.',
    'home.leaveConfirm': 'לעזוב את המשחק הנוכחי?',
    'home.browsePublic': 'חדרים ציבוריים',
    'home.haveCode': 'יש לך קוד חדר?',
